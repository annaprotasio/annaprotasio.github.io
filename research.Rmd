...
Parasitic flatworms also known as helminths are fantastic animals that have co-evolved with their human and other animal hosts maximising the parasitic relationship. My favourite parasite is _Schistosoma mansoni_ but I am passionate about all little crawling things! 
...
<img src="images/nuclear_silencing.jpg" style="width:50%; border:5px solid; margin-right: 20px; float:left" >
...
Parasitic flatworms lack both the canonical piRNA pathway characterised by PIWI proteins (6,7) and the RNA-dependent RNA-polymerase ubiquitous in species in which the piRNA pathway is absent. They do have a set of Dicer and Argonaute enzymes suggesting that some key players of the post-transcriptional control of TEs are present. In particular, flatworm Argonautes are phylogenetically distinct from model organism Argonautes and PIWI proteins. They are also found in very low numbers: parasitic flatworms only have three Argonaute proteins (6) while nematodes have more than twenty (8). Parasitic flatworms present an exciting opportunity to uncover novel molecular pathways for post-transcriptional TE control.